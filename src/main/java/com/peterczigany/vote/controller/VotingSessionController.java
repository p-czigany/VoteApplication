...
@RestController /*(value = "/szavazasok")*/
public class VotingSessionController {
  ...
  public @ResponseBody CreationResponse createVotingSession(
      @RequestBody final VotingSessionDTO votingSession) throws VoteException {
